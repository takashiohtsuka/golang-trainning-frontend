...
type Store struct {
	...
	Women        collection.Collection[WomanDTO] `json:"women"`
...
func (s *Store) GetWomen() collection.Collection[WomanDTO] { return s.Women }
...
func (n *NilStore) GetWomen() collection.Collection[WomanDTO] {
	return collection.NewCollection[WomanDTO](nil)
}
