...
type Woman struct {
	...
	Blogs            collection.Collection[BlogQueryModel]           `json:"blogs"`
...
func (w *Woman) GetBlogs() collection.Collection[BlogQueryModel]     { return w.Blogs }
...
func (n *NilWoman) GetBlogs() collection.Collection[BlogQueryModel] {
	return collection.NewCollection[BlogQueryModel](nil)
}
